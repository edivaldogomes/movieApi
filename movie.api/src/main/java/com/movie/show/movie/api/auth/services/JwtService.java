...
public class JwtService {
    private static String SECRET_KEY = "wadgko2hjCCd311zSeA9ZZAGQf15/atrR9HZUBhuCCk="; // Convert to base 64 in this website (https://hash.online-convert.com/es/generador-sha256)
    ...
    public String generateToken(Map<String, Object> extractClaims, UserDetails userDetails) {
        long tokenTime = 200 * 60 * 24;
        // long tokenTime = 25 * 1000;
