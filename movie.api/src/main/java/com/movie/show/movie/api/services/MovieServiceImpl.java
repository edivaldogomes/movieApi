...
public class MovieServiceImpl implements MovieService {
    ...
    @Override
    public MoviePageResponse getAllMoviesWithPagination(Integer pageNumber, int pageSize) throws IOException {
    ...
    @Override
    public MoviePageResponse getAllMoviesWithPaginationAndSorting(Integer pageNumber, int pageSize, String sortBy, String dir) throws IOException {
